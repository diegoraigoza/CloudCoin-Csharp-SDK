...
namespace CloudCoinCsharpSDK
{
    ...
    public class CloudBankUtils : ICloudBankUtils
    {
        ...
        //Calls the CloudService's show_coins service using field keys. The results are saved in this class's public properties if successful.
        ...
        //sets field rawStackForDeposit to a CloudCoin stack read from a file
        //param filepath needs to be the full filepath and filename of the CloudCoin stack that is being loaded
        public void loadStackFromFile(string filepath)
        {
            rawStackForDeposit = File.ReadAllText(filepath);
        }

        //sends the cloudcoin loaded with loadStackFromFile to the CloudService server using field keys
        ...
        //sends the cloudcoin loaded with loadStackFromFile to a CloudService server specified by param toPublicURL
        ...
        //retrieve the receipt of the last generated by the CloudService for the last sendStackToCloudBank
        ...
        //retrieves CloudCoins from CloudService using field keys. param amountToWithdraw is the amount of CloudCoins to withdraw
        ...
        //method used to calculate a CloudCoin note's denomination using it serial number(sn)
        ...
        //retrieves CloudCoins from CloudService using field keys. the amount withdrawn is the same as the amount last deposited with sendStackToCloudBank
        //the resulting stack that is retrieved is saved in private field rawStackFromWithdrawal
        ...
        //parses pertinent information from the receipt last gathered by getReceipt and returns it in the form of an Interpretation
